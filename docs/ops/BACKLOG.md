...
| ID | Task | Est. Hours | Dependencies | Owner | Done When |
|---|---|---:|---|---|---|
| P1-01 | Publish first 10 pages using template v1 | 8-10h | P0-05, P0-07 | Founder | 10 pages live and internally linked |
...
### Day 4-6
- Execute `P0-05` to `P0-08`.
- Output: locked template + taxonomy + first 20 URL plan + rendering config aligned.
